<div class="flex-shrink-0 p-3 bg-white me-2" style="width: 280px;">
        ...
        <span class="text-center">
          <img src="./uploads/img/avarta/avt.jpg" alt="Logo" width="180" height="180" class="rounded-circle" alt="Cinque Terre"> 
      ...
      <ul class="list-unstyled ps-0">
        ...
        ?>
          ...
          <div class="collapse" id="dm-collapse">
            <ul class="btn-toggle-nav list-unstyled fw-normal pb-1 small ps-4">
              <li><a href="admin.php?controller=category" class="link-dark d-inline-flex text-decoration-none rounded p-2"><i class="bi bi-caret-right-fill"></i>Tất cả danh mục</a></li>
              <li><a href="admin.php?controller=category&action=insert" class="link-dark d-inline-flex text-decoration-none rounded p-2"><i class="bi bi-caret-right-fill me-1"></i>Thêm danh mục</a></li>
            </ul>
          </div>
        </li>
        ...
        ?>
          ...
          <div class="collapse" id="sp-collapse">
            <ul class="btn-toggle-nav list-unstyled fw-normal pb-1 small ps-4">
                <li><a href="admin.php?controller=product" class="link-dark d-inline-flex text-decoration-none rounded p-2"><i class="bi bi-caret-right-fill me-1"></i>Tất cả sản phẩm</a></li>
                <li><a href="admin.php?controller=product&action=insert" class="link-dark d-inline-flex text-decoration-none rounded p-2"><i class="bi bi-caret-right-fill me-1"></i>Thêm sản phẩm</a></li>
                <li><a href="admin.php?controller=product&action=proDeleted" class="link-dark d-inline-flex text-decoration-none rounded p-2"><i class="bi bi-caret-right-fill me-1"></i>Sản phẩm đã xóa</a></li>
            </ul>
          </div>
        </li>
        ...
        ?>
          ...
          <div class="collapse" id="slide-collapse">
            <ul class="btn-toggle-nav list-unstyled fw-normal pb-1 small ps-4">
                <li><a href="admin.php?controller=slide" class="link-dark d-inline-flex text-decoration-none rounded p-2"><i class="bi bi-caret-right-fill me-1"></i>Tất cả slide</a></li>
                <li><a href="admin.php?controller=slide&action=insert" class="link-dark d-inline-flex text-decoration-none rounded p-2"><i class="bi bi-caret-right-fill me-1"></i>Thêm slide</a></li>
            </ul>
          </div>
        </li>
        ...
        ?>
          ...
          <div class="collapse" id="hd-collapse">
            <ul class="btn-toggle-nav list-unstyled fw-normal pb-1 small ps-4">
                <li><a href="admin.php?controller=order" class="link-dark d-inline-flex text-decoration-none rounded p-2"><i class="bi bi-caret-right-fill me-1"></i>Tất cả hóa đơn</a></li>
            </ul>
          </div>
        </li>
        ...
        ?>
          ...
          <div class="collapse" id="account-collapse">
            <ul class="btn-toggle-nav list-unstyled fw-normal pb-1 small ps-4">
                <li><a href="admin.php?controller=user&action=changeInfo" class="link-dark d-inline-flex text-decoration-none rounded p-2"><i class="bi bi-caret-right-fill me-1"></i>Thay đổi thông tin</a></li>
                <li><a href="admin.php?controller=user&action=changePass" class="link-dark d-inline-flex text-decoration-none rounded p-2"><i class="bi bi-caret-right-fill me-1"></i>Đổi mật khẩu</a></li>
                <li><a href="#" data-bs-toggle="modal" data-bs-target="#exampleModal" class="link-dark d-inline-flex text-decoration-none rounded p-2"><i class="bi bi-caret-right-fill me-1"></i>Đăng xuất</a></li>
